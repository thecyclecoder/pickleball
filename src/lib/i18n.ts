...
const UI = {
  en: {
    ...
    form_email: "Email",
    form_phone: "WhatsApp / phone (optional)",
    form_phone_hint: "Used for reminders and last-minute updates.",
    form_rating: "Rating",
  ...
  es: {
    ...
    form_email: "Correo",
    form_phone: "WhatsApp / teléfono (opcional)",
    form_phone_hint: "Para recordatorios y cambios de última hora.",
    form_rating: "Nivel",
