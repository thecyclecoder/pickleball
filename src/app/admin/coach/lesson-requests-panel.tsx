...
export function LessonRequestsPanel({ requests }: { requests: LessonRequest[] }) {
          ...
          {requests.map((r) => {
            ...
            return (
              <li key={r.id} className="px-5 py-3 text-sm">
                ...
                {isOpen && (
                  <div className="mt-3 space-y-2 rounded-lg border border-zinc-800 bg-zinc-950/40 p-3 text-xs text-zinc-300">
                    <p className="text-[10px] uppercase tracking-wider text-zinc-500">Reply to</p>
                    <p>
                      <a
                        href={`mailto:${r.email}`}
                    ...
                    {r.schedule_notes && (
                      <div>
                        <p className="text-[10px] uppercase tracking-wider text-zinc-500">Schedule notes</p>
